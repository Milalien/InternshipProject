...
echo "<div class='editSubPage'><h1>Mökki 1 sivun muokkaus</h1><div class='subPageForms'><div class='form subPage'>";
switch($lang){
  case "fi":
...
echo "<form action='update.php' method='post' enctype='multipart/form-data'>
  ...
  <textarea class='editable' name='hinnasto' style='height:30px;'>".$info["hinnasto"]."</textarea>
  ...
  switch($lang){
    case "fi":
      echo "<input type='hidden' name='toiminto' value='cabin1fi'>";
      break;
    case "en":
      echo "<input type='hidden' name='toiminto' value='cabin1en'>";
      break;
    case "nl":
      echo "<input type='hidden' name='toiminto' value='cabin1nl'>";
      break;
    default:
      echo "<input type='hidden' name='toiminto' value='cabin1fi'>";
  }
...
</div><div><input type='hidden' name='toiminto' value='cabin1map'>
...
</div><div><input type='hidden' name='toiminto' value='cabin1video'>
<input type='submit' value='Päivitä' name='submit' class='submit'></div>
</form></div></div>";
?>
...
<h4>Lisää uusi:</h4>
<form action="update.php" method="post" enctype="multipart/form-data">
  <label for="slideCabin1">Valitse uusi slider-kuva:</label><br>
  <input type="file" id="slideCabin1" name="slideCabin1"><br>
  <input type="hidden" name="toiminto" value="newSlideCabin1"><br>
...
<form action="update.php" method="post" enctype="multipart/form-data">
  ...
  while($row = $result->fetch_assoc()) {
	...
	<img src=".$row["kuva"]."><a href='update.php?toiminto=deleteSlideCabin1&id=".$row["id"]."' type='button' class='btn'>Poista</a>
	</li>";
  ...
  echo "</ul>";
	...
	$conn->close();
  ?>
  <input type="hidden" name="toiminto" value="slideOrderCabin1"><br>
