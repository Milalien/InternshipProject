...
$stmt = $conn->prepare("SELECT otsikko,esittelyteksti FROM omaesittely WHERE kieli=?");
...
echo "<div class='editSubPage'><h1>Oman esittelyn muokkaus</h1><div class='subPageForms'>";
...
echo "<form action='update.php' method='post' enctype='multipart/form-data'>
  ...
  switch($lang){
    case "fi":
      echo "<input type='hidden' name='toiminto' value='aboutfi'>";
      break;
    case "en":
      echo "<input type='hidden' name='toiminto' value='abouten'>";
      break;
    case "nl":
      echo "<input type='hidden' name='toiminto' value='aboutnl'>";
      break;
    default:
      echo "<input type='hidden' name='toiminto' value='aboutfi'>";
  }
...
$stmt = $conn->prepare("SELECT kuva FROM omaesittely LIMIT 1");
$stmt->execute();
...
<form action='update.php' method='post' enctype='multipart/form-data'>
  <label for='abimg'><img src=".$kuva." style='width:80%;'></label><br>
  <input type='file' id='abimg' name='abimg'><br>
  <input type='hidden' name='toiminto' value='aboutimage'><br>
